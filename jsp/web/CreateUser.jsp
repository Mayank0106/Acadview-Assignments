...
try{
		...
		Statement st=con.createStatement();
                ...
                if(rs.next())
                {
                        ...
                        out.println("<a href=reg.jsp>Create New User</a></center>");
                }
                else
                {
                   ...
                   int n=st.executeUpdate(sql);
                        if(n>0)
                        {
                             ...
                             out.println("<p><center><h1> <a href='BackHomePage.jsp'>Back To HOME Page</a></h1></center>"); 
			     out.println("<p><center><h1> <a href='signup.jsp'>Back To Sign in Form</a> </h1></center>");	
                        }
                        else
                        {
